...
export const JP = {
  ...
  '假付款資訊': '偽の支払い情報',
  '買家聲稱已經付款，但買東東沒有這筆訂單，你也沒有確認到可信的付款紀錄或實際入帳。對方提供的付款說法不能當作收款證明。': '買い手は支払い済みだと主張しましたが、買東東には該当する注文がなく、信頼できる支払い記録も実際の入金も確認できませんでした。相手の支払い済みという説明だけでは、代金を受け取った証拠にはなりません。',
  '假身分驗證': '偽の本人確認',
